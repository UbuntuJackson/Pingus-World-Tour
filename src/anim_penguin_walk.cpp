...
AnimPenguinWalk::AnimPenguinWalk(PingusWorldTour* _game) : Animation(_game, olc::vf2d{32.0f, 32.0f}, 0.3f, "penguin_walking"), game{static_cast<PingusWorldTour*>(_game)}{
